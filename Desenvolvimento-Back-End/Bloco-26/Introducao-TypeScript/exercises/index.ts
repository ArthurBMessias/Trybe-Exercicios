...
console.log(`Trapezio de altura 50cm, base maior 100cm e base menor 70cm: ${Exercise.trapeze(50, 100, 70)}cm²`)
console.log(`Círculo de raio 25cm ${Exercise.circle(25, 3.14)}cm`)